...
class ElectionsClient extends $grpc.Client {
  ...
  ElectionsClient($grpc.ClientChannel channel, {$grpc.CallOptions options})
      : super(channel, options: options);

  $grpc.ResponseFuture<$1.Empty> viewChange($0.ViewChangeRequest request,
      {$grpc.CallOptions options}) {
    final call = $createCall(
        _$viewChange, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
  ...
  $grpc.ResponseFuture<$1.Empty> viewChangeProof(
      ...
      {$grpc.CallOptions options}) {
    final call = $createCall(
        _$viewChangeProof, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
  ...
  $grpc.ResponseFuture<$1.Empty> prepare($0.PrepareRequest request,
      {$grpc.CallOptions options}) {
    final call = $createCall(_$prepare, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
  ...
  $grpc.ResponseFuture<$1.Empty> prepareOk($0.PrepareOkRequest request,
      {$grpc.CallOptions options}) {
    final call = $createCall(_$prepareOk, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
  ...
  $grpc.ResponseFuture<$1.Empty> proposal($0.ProposalRequest request,
      {$grpc.CallOptions options}) {
    final call = $createCall(_$proposal, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
  ...
  $grpc.ResponseFuture<$1.Empty> leaderIsResigning(
      ...
      {$grpc.CallOptions options}) {
    final call = $createCall(
        _$leaderIsResigning, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
  ...
  $grpc.ResponseFuture<$1.Empty> leaderIsResigningOk(
      ...
      {$grpc.CallOptions options}) {
    final call = $createCall(
        _$leaderIsResigningOk, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
}
