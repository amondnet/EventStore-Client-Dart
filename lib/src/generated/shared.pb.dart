...
class UUID_Structured extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UUID.Structured',
      package: const $pb.PackageName('event_store.client.shared'),
...
class StreamIdentifier extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StreamIdentifier',
      package: const $pb.PackageName('event_store.client.shared'),
      createEmptyInstance: create)
    ..a<$core.List<$core.int>>(3, 'streamName', $pb.PbFieldType.OY,
